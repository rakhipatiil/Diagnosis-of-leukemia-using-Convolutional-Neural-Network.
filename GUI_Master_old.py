...
root.title("Diagnosis of Leukemia Using Convolution Neural Networks.")
...
#
lbl = tk.Label(root, text="Diagnosis of Leukemia Using Convolution Neural Networks", font=('times', 32,' bold '), height=1, width=42,bg="seashell2",fg="Black")
...
#        retval, threshold = cv2.threshold(gs, 0, 255, cv2.THRESH_BINARY_INV + cv2.THRESH_OTSU)
    ...
    lbl = tk.Label(root, text="Original image", font=('times', 20,' bold '), height=1, width=17,fg="Black")
    lbl.place(x=290, y=350)
...
def convert_grey():
    ...
    lbl = tk.Label(root, text="Grayscale-image", font=('times', 20,' bold '), height=1, width=17,fg="Black")
    lbl.place(x=570, y=350)
    ...
    img3.image = imgtk
    img3.place(x=870, y=100)
    lbl = tk.Label(root, text="Threshold-image", font=('times', 20,' bold '), height=1, width=18,fg="Black")
    lbl.place(x=850, y=350)
...
#
button4 = tk.Button(frame_alpr, text="CNN Prediction", command=test_model,width=15, height=1,bg="white",fg="black", font=('times', 15, ' bold '))
